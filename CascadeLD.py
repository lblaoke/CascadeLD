...
def lane_detect(im_tensor):
	...
	segmentation_network.load_state_dict(torch.load(path+'pretrained/erfnet_tusimple.pth', map_location = map_location))
	model_path = path+'pretrained/classification_{}_{}class.pth'.format(DESCRIPTOR_SIZE, NUM_CLASSES_CLASSIFICATION)
